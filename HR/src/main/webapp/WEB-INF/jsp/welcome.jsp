<%@page import="com.wls.entity.Employee"%>
            ...
            <div class="col-sm-12">
              <div class="jumbotron">
              	<div style="margin-left: 200px">
					...
					<h1><%=employee.getName() %></h1><p >   禺兴企业人事管理系统</p>
					<p id="time" style="font-size:70px">&nbsp;</p>
					<p><a href="<%=path %>/attendance/addStart.do?employeeNumber=<%=employee.getEmployeeNumber() %>" 
							class="btn btn-primary btn-lg" style="font-size:50px">&nbsp;上班签到&nbsp;</a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
						<a href="<%=path %>/attendance/addEnd.do?employeeNumber=<%=employee.getEmployeeNumber() %>" 
							class="btn btn-primary btn-lg" style="font-size:50px">下班签到&nbsp;</a>
					</p>
					<p>&nbsp;</p>
					<p>&nbsp;</p>
                </div>
