 ...
 * Generated at: 2020-08-08 06:09:14 UTC
...
public final class employee_005fupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String birthday = MTimeUtil.dateFormat(employee.getBirthday()); 
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-7\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<select class=\"form-control m-b\" name=\"departmentNumber\" size=\"1\" required>\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">职称</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-7\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<select class=\"form-control m-b\" name=\"positionNumber\" size=\"1\" required>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"\">--请选择职称--</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-7\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<select class=\"form-control m-b\" name=\"status\" size=\"1\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"在职\">在职</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"退休\">退休</option>\n");
