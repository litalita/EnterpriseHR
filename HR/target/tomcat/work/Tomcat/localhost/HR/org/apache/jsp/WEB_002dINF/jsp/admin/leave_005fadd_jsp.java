 ...
 * Generated at: 2020-08-08 06:35:03 UTC
...
public final class leave_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String path = request.getContextPath(); 
      ...
      out.write("\t<title>HR医院 - 申请请假</title>\n");
      ...
      out.write("\t\t\t\t\t\t<h5>申请请假</h5>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"ibox-content\">\n");
      out.write("\t\t\t\t\t\t");
 Employee employee = (Employee)session.getAttribute("loged");
      out.write("\n");
      out.write("\t\t\t\t\t\t<form method=\"post\" class=\"form-horizontal\" id=\"commentForm\" \n");
      out.write("\t\t\t\t\t\t\taction=\"");
      out.print(path );
      out.write("/leave/add.do?employeeNumber=");
      out.print(employee.getEmployeeNumber());
      out.write("&departmentNumber=");
      out.print(employee.getDepartmentNumber());
      out.write("\">\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">起始时间</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-7\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"date\" class=\"form-control\" name=\"start\" required>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">结束时间</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-7\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"date\" class=\"form-control\" name=\"end\" required>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">天数</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-7\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"days\" required>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">类型</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-7\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<select class=\"form-control m-b\" name=\"type\" size=\"1\" required>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"事假\">事假</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"病假\">病假</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-3 control-label\">请假原因</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-7\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea class=\"form-control\" rows=\"3\" name=\"reason\" required></textarea>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"hr-line-dashed\"></div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-4 col-sm-offset-8\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<button class=\"btn btn-success\" type=\"submit\">申&nbsp;&nbsp;请</button>&nbsp;&nbsp;&nbsp;&nbsp;\n");
      ...
      out.write("\t    \tparent.layer.alert('申请成功！',{icon: 1}),\n");
