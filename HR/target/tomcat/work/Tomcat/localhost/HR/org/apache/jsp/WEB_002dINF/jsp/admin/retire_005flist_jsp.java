 ...
 * Generated at: 2020-08-08 06:36:31 UTC
...
public final class retire_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String path = request.getContextPath(); 
      ...
      out.write("\t<title>HR医院 - 退休员工列表</title>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<th>离休时间</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t<th width=\"60px\">类别</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>管理</th>\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t</thead>\n");
      out.write("\t\t\t\t\t\t\t<tbody>\n");
      ...
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(history.getEmployeeNumber() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(history.getName() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(history.getGender() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(history.getTelephone() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(history.getDepartment().getName() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(history.getPosition().getName() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("/detail.do\" class=\"btn btn-info\">查看</a>&nbsp;&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"");
      out.print(path );
      out.write("/history/");
      out.print(history.getId() );
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"");
      out.print(path );
      out.write("/history/retireListPage.do?pageNo=");
