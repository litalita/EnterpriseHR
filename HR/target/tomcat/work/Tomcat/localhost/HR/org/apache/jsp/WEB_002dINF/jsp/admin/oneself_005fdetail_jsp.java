 ...
 * Generated at: 2020-08-08 06:10:18 UTC
...
public final class oneself_005fdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String path = request.getContextPath(); 
      ...
      out.write("\t<title>HR医院 - 查看个人信息</title>\n");
 ...
 Employee employee = (Employee)request.getAttribute("employee"); 
      ...
      out.write("\t\t\t\t\t\t    \t<div class=\"col-md-1\"></div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
      out.write("\t\t\t\t\t\t\t        <label class=\"col-sm-8 control-label\">性别：</label>\n");
      out.write("\t\t\t\t\t\t\t        <p class=\"form-control-static\">");
      out.print(employee.getGender() );
      out.write("</p>\n");
      out.write("\t\t\t\t\t\t   \t\t</div>\n");
      out.write("\t\t\t\t\t\t   \t\t<div class=\"col-md-4\">\n");
      out.write("\t\t\t\t\t\t\t        <label class=\"col-sm-5 control-label\">出生日期：</label>\n");
      out.write("\t\t\t\t\t\t\t        ");
 String birthday = MTimeUtil.dateFormat(employee.getBirthday()); 	
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-1\"></div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
      out.write("\t\t\t\t\t\t\t        <label class=\"col-sm-8 control-label\">电话：</label>\n");
      out.write("\t\t\t\t\t\t\t        <p class=\"form-control-static\">");
      out.print(employee.getTelephone() );
      out.write("</p>\n");
      out.write("\t\t\t\t\t\t   \t\t</div>\n");
      out.write("\t\t\t\t\t\t   \t\t<div class=\"col-md-4\">\n");
      out.write("\t\t\t\t\t\t\t        <label class=\"col-sm-5 control-label\">邮箱：</label>\n");
      out.write("\t\t\t\t\t\t\t        <p class=\"form-control-static\">");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-1\"></div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
      out.write("\t\t\t\t\t\t\t        <label class=\"col-sm-8 control-label\">籍贯：</label>\n");
      out.write("\t\t\t\t\t\t\t        <p class=\"form-control-static\">");
      out.print(employee.getAddress() );
      out.write("</p>\n");
      out.write("\t\t\t\t\t\t   \t\t</div>\n");
      out.write("\t\t\t\t\t\t   \t\t<div class=\"col-md-4\">\n");
      out.write("\t\t\t\t\t\t\t        <label class=\"col-sm-5 control-label\">学历：</label>\n");
      out.write("\t\t\t\t\t\t\t        <p class=\"form-control-static\">");
      ...
      out.write("\t\t\t\t\t\t    \t<div class=\"col-md-1\"></div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
      out.write("\t\t\t\t\t\t\t        <label class=\"col-sm-8 control-label\">部门：</label>\n");
      out.write("\t\t\t\t\t\t\t        <p class=\"form-control-static\">");
      out.print(employee.getDepartment().getName() );
      out.write("</p>\n");
      out.write("\t\t\t\t\t\t   \t\t</div>\n");
      out.write("\t\t\t\t\t\t   \t\t<div class=\"col-md-4\">\n");
      out.write("\t\t\t\t\t\t\t        <label class=\"col-sm-5 control-label\">职称：</label>\n");
      out.write("\t\t\t\t\t\t\t        <p class=\"form-control-static\">");
      out.print(employee.getPosition().getName() );
      out.write("</p>\n");
      out.write("\t\t\t\t\t\t\t    </div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t    \t<div class=\"col-md-1\"></div>\n");
      out.write("\t\t\t\t\t\t    \t<div class=\"col-md-4\">\n");
      out.write("\t\t\t\t\t\t\t        <label class=\"col-sm-8 control-label\">入职时间：</label>\n");
      out.write("\t\t\t\t\t\t\t         ");
 String inttime = MTimeUtil.dateFormat(employee.getInTime()); 	
      ...
      out.write("\t\t\t\t\t\t   \t\t</div>\n");
      out.write("\t\t\t\t\t\t   \t\t<div class=\"col-md-4\">\n");
      out.write("\t\t\t\t\t\t\t        <label class=\"col-sm-5 control-label\">备注：</label>\n");
      out.write("\t\t\t\t\t\t\t        <p class=\"form-control-static\">");
      ...
      out.write("/toUpdate.do\" class=\"btn btn-primary\">修&nbsp;&nbsp;改</a>&nbsp;&nbsp;\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"");
      out.print(path );
      out.write("/employee/welcome.do\" class=\"btn btn-info\">返&nbsp;&nbsp;回</a>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t</div>\n");
