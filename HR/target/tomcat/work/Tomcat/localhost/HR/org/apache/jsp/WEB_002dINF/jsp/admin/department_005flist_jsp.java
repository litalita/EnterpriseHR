 ...
 * Generated at: 2020-08-08 06:36:49 UTC
...
public final class department_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String path = request.getContextPath(); 
      ...
      out.write("\t<title>HR医院 - 部门列表</title>\n");
      ...
      out.write("\t\t\t\t\t\t<h5>部门列表</h5>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"ibox-content\">\n");
      out.write("\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"");
      out.print(path );
      out.write("/department/toAdd.do\" class=\"btn btn-success\">添加部门</a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<th>电话</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>地址</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t<th width=\"180px\">备注</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>管理</th>\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t</thead>\n");
      out.write("\t\t\t\t\t\t\t<tbody>\n");
      ...
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(department.getTelephone() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(department.getAddress() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(department.getNotes() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><a href=\"");
      out.print(path );
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"");
      out.print(path );
      out.write("/department/listPage.do?pageNo=");
